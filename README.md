...
The program read an input file named list.txt, containing the address to find (one per line) and outputs the coordinates into a file called coordinates.txt
